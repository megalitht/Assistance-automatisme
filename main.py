...
while True:
    ...
    # Si on a entendu quelque chose ET que c'est "george"
    if appel and "george" in appel.lower():
        print("\nOui Monsieur ? Que puis-je faire pour vous ?")
        
        # 2. ÉCOUTE ACTIVE (La vraie commande)
        # Maintenant on écoute normalement (avec les textes affichés)
